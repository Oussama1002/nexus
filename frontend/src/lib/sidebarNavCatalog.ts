...
export const SIDEBAR_NAV_CATALOG: SidebarNavCatalogEntry[] = [
  ...
  { key: 'ordersNew', view: 'ordersNew', groupId: 'commerce', groupLabel: 'Commerce', label: 'Nouvelle commande', icon: Package, configurable: true },
  { key: 'orders', view: 'orders', groupId: 'commerce', groupLabel: 'Commerce', label: 'Commandes', icon: Package, configurable: true },
  { key: 'whatsapp', view: 'whatsapp', groupId: 'commerce', groupLabel: 'Commerce', label: 'Conversations', icon: MessageSquare, configurable: true },
  { key: 'academy', view: 'academy', groupId: 'commerce', groupLabel: 'Commerce', label: 'Brandna academy', icon: BookOpenCheck, configurable: true },
  ...
  { key: 'stock', view: 'stock', groupId: 'operations', groupLabel: 'Opérations', label: 'Stocks', icon: Package, configurable: true },
  ...
  { key: 'purchaseOrders', view: 'purchaseOrders', groupId: 'operations', groupLabel: 'Opérations', label: 'Commandes fournisseurs', icon: Package, configurable: true },
  ...
  { key: 'finance', view: 'finance', groupId: 'management', groupLabel: 'Management', label: 'Finance', icon: PieChart, configurable: true },
  { key: 'usersAdmin', view: 'usersAdmin', groupId: 'management', groupLabel: 'Management', label: 'Utilisateurs', icon: Users, configurable: true },
  { key: 'settings', view: 'settings', groupId: 'management', groupLabel: 'Management', label: 'Paramètres', icon: Settings, configurable: true },
  { key: 'tracking', view: 'tracking', groupId: 'management', groupLabel: 'Management', label: 'Historique', icon: BarChart3, configurable: true },
];

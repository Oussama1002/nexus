...
class StoreContentProductionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'production_type' => ['required', Rule::in(['shooting', 'editing', 'design', 'copywriting', 'live_preparation'])],
            'location' => ['nullable', 'string', 'max:255'],
            'equipment_notes' => ['nullable', 'string'],
            'crew_notes' => ['nullable', 'string'],
            'asset_path' => ['nullable', 'string', 'max:2000'],
            'status' => ['nullable', Rule::in(['todo', 'in_progress', 'submitted', 'validated', 'rejected'])],
